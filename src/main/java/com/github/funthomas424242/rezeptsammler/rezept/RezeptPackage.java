...
public interface RezeptPackage extends EPackage
{
   ...
   * @ordered
   */
  int PROJEKT_BESCHREIBUNG__BUCH = METADATEN_FEATURE_COUNT + 4;
   ...
   * @ordered
   */
  int PROJEKT_BESCHREIBUNG_FEATURE_COUNT = METADATEN_FEATURE_COUNT + 5;
