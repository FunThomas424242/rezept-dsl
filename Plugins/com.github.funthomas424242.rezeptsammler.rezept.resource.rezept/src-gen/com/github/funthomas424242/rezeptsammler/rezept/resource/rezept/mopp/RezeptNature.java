...
public class RezeptNature implements IProjectNature {
	
	public static final String NATURE_ID = "com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
