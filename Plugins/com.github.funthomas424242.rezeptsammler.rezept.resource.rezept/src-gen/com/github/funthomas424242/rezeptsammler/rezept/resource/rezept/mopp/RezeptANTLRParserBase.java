...
public abstract class RezeptANTLRParserBase extends Parser implements com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextParser {
	 ...
	 * result object.
	 */
	protected Collection<com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptCommand<com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource>> postParseCommands;
	 ...
	 */
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptTokenResolveResult tokenResolveResult = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptTokenResolveResult();
	...
	public RezeptANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public RezeptANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptPlaceholder;
		isElementToStore |= syntaxElement instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptKeyword;
		isElementToStore |= syntaxElement instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptDummyEObject);
			com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptDummyEObject dummy = (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptDummyEObject) object;
	...
	protected com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptTokenResolveResult getFreshTokenResolveResult() {
	...
	protected com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptReferenceResolverSwitch getReferenceResolverSwitch() {
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptReferenceResolverSwitch resolverSwitch = (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}
