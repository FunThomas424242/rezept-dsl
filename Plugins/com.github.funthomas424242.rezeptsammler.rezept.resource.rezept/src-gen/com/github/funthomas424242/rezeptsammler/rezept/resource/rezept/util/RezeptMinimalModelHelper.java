 ...
 */
public class RezeptMinimalModelHelper {
	
	private final static com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptEClassUtil eClassUtil = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptEClassUtil();
			...
			if (feature instanceof EReference) {
				...
				if (type instanceof EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof List<?>) {
							List<EObject> list = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof List<?>) {
						List<String> list = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptListUtil.castListUnchecked(value);
