...
public class RezeptCopiedEObjectInternalEList extends com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public RezeptCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
