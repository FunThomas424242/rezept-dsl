 ...
 */
public class RezeptEObjectUtil {
	...
	public static Object invokeOperation(EObject element, EOperation o) {
		...
		try {
			...
			new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.util.RezeptRuntimeUtil().logError("Exception while matching proxy URI.", e);
