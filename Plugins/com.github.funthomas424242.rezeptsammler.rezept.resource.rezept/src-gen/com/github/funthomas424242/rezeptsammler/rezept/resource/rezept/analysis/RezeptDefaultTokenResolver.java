 ...
 * </p>
 */
public class RezeptDefaultTokenResolver implements com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTokenResolver {
	 ...
	 */
	public RezeptDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public RezeptDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptGrammarInformationProvider.INSTANCE.getKeywords()) {
