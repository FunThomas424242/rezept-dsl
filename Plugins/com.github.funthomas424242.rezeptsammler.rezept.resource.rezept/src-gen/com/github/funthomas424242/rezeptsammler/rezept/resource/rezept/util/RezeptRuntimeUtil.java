 ...
 */
public class RezeptRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
