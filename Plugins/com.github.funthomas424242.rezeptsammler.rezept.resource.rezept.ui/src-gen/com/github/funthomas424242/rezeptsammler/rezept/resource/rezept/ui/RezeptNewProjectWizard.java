 ...
 * </p>
 */
public class RezeptNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptNewProj
	 * ectWizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}
