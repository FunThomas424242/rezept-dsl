 ...
 * a specified depth.
 */
public class RezeptOutlinePageTreeViewer extends TreeViewer {
	...
	public RezeptOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptPlugin.logError("Exception while refreshing outline view", e);
		}
	}
