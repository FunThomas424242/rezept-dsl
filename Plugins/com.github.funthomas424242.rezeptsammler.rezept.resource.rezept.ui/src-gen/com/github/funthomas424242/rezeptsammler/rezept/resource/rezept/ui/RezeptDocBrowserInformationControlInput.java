 ...
 * olInput</code>.
 */
public class RezeptDocBrowserInformationControlInput {
	
	private final RezeptDocBrowserInformationControlInput fPrevious;
	private RezeptDocBrowserInformationControlInput fNext;
	 ...
	 */
	public RezeptDocBrowserInformationControlInput(RezeptDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public RezeptDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public RezeptDocBrowserInformationControlInput getNext() {
		return fNext;
	}
