 ...
 */
public class RezeptCompletionProposal implements Comparable<RezeptCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptExpectedTerminal expectedTerminal;
	...
	public RezeptCompletionProposal(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public RezeptCompletionProposal(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public RezeptCompletionProposal(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof RezeptCompletionProposal) {
			RezeptCompletionProposal other = (RezeptCompletionProposal) object;
	...
	public int compareTo(RezeptCompletionProposal object) {
		if (object instanceof RezeptCompletionProposal) {
			RezeptCompletionProposal other = (RezeptCompletionProposal) object;
