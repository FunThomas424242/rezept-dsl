...
public class RezeptOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptNameProvider nameProvider = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptMetaInformation().createNameProvider();
