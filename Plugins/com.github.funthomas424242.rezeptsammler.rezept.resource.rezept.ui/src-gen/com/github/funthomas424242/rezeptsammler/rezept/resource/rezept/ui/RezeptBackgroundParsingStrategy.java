 ...
 */
public class RezeptBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource resource, final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource resource, final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource resource, final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptResource) {
							com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptResource concreteResource = (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptResource) resource;
