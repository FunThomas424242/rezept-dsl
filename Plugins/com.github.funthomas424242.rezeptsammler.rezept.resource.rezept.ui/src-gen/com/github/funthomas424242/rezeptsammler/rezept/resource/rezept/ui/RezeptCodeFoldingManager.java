 ...
 */
public class RezeptCodeFoldingManager {
	
	private class FoldingUpdateListener implements com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements IPartListener2 {
		...
		public EditorOnCloseListener(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor) {
				com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor = (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor) workbenchPart;
	...
	protected com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor;
	 ...
	 */
	public RezeptCodeFoldingManager(ProjectionViewer sourceViewer,com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor textEditor) {
	...
	private void addCloseListener(final com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptResource textResource = (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptResource) editor.getResource();
		IDocument document = sourceViewer.getDocument();
