...
public class RezeptBracketSet {
	...
	private ArrayList<com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public RezeptBracketSet() {
		super();
		...
		this.bracketPairs = new ArrayList<com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair>();
	}
	...
	public com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair getBracketPair(String opening, String closing) {
		for (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair remove(String opening, String closing) {
		for (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
