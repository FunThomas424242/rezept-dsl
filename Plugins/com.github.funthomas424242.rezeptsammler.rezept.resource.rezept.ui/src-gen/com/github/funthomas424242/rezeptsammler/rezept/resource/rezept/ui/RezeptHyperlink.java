 ...
 */
public class RezeptHyperlink implements IHyperlink {
	 ...
	 */
	public RezeptHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
