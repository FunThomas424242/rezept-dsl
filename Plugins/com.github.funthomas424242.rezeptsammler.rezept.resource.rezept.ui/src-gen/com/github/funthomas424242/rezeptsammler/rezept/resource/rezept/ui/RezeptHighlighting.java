 ...
 */
public class RezeptHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor;
	private ProjectionViewer projectionViewer;
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOccurrence occurrence;
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBackgroundParsingListener {
	 ...
	 */
	public RezeptHighlighting(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource textResource, ProjectionViewer projectionViewer, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptColorManager colorManager, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOccurrence(textResource, projectionViewer);
		this.bracketSet = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
