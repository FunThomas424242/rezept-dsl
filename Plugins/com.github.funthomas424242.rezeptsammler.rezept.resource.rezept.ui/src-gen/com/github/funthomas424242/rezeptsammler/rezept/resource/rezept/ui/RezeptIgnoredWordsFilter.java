 ...
 */
public class RezeptIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.grammar.RezeptGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
