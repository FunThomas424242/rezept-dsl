 ...
 */
public class RezeptImageProvider {
	
	public final static RezeptImageProvider INSTANCE = new RezeptImageProvider();
	...
	public ImageDescriptor getImageDescriptor(String key) {
		...
		if (ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
