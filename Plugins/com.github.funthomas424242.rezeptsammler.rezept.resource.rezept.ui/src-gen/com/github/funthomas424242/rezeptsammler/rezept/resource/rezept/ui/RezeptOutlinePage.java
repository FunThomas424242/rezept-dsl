 ...
 */
public class RezeptOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.outlinecontext";
	...
	public RezeptOutlinePage(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOutlinePageTreeViewer) {
								com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOutlinePageTreeViewer pageTreeViewer = (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOutlinePageActionProvider().getActions(treeViewer);
