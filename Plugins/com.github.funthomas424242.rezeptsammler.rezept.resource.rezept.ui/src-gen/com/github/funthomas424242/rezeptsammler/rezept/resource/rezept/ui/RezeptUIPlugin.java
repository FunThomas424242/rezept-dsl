 ...
 */
public class RezeptUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui";
	public static final String EDITOR_ID = "com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor";
	...
	private static RezeptUIPlugin plugin;
	
	public RezeptUIPlugin() {
		super();
	}
	...
	public static RezeptUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, RezeptUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, RezeptUIPlugin.PLUGIN_ID, message);
		}
		final RezeptUIPlugin pluginInstance = RezeptUIPlugin.getDefault();
