 ...
 */
public class RezeptOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.occurences.declaration";
	
	private final static com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionHelper positionHelper = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionHelper();
	 ...
	 */
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a RezeptOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public RezeptOccurrence(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.analysis.RezeptDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptLocationMap locationMap = textResource.getLocationMap();
		
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner tokenScanner = createTokenScanner();
	...
	protected com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.IRezeptTokenScanner createTokenScanner() {
		return new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory type, String text, int offset, int length) {
		...
		if (type == com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptOccurrence.DECLARATION_ANNOTATION_ID);
	}
