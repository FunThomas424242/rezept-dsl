 ...
 * @since 3.2
 */
public class RezeptBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptDocBrowserInformationControlInput fInput;
	 ...
	 */
	public RezeptBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public RezeptBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public RezeptBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptDocBrowserInformationControlInput);
		...
		fInput= (com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptDocBrowserInformationControlInput) input;
		...
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptDocBrowserInformationControlInput getInput() {
		return fInput;
	}
