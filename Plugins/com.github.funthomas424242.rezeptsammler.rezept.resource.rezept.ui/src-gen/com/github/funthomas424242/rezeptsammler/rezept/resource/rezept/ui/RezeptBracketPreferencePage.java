 ...
 * </p>
 */
public class RezeptBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptMetaInformation().getSyntaxName();
	
	private com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public RezeptBracketPreferencePage() {
		super();
		
		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptMetaInformation metaInformation = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.mopp.RezeptMetaInformation();
	...
	public void init(IWorkbench workbench) {
		setPreferenceStore(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptBracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		matchingBracketsColorEditor.setColorValue(PreferenceConverter.getDefaultColor(preferenceStore, BRACKETS_COLOR));
		String defaultBrackets = preferenceStore.getDefaultString(language + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		IWorkbench workbench = org.eclipse.ui.PlatformUI.getWorkbench();
		IEditorPart editor = workbench.getActiveWorkbenchWindow().getActivePage().getActiveEditor();
		if (editor != null && editor instanceof com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor) {
			((com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.ui.RezeptEditor) editor).invalidateTextRepresentation();
		}
	}
	
	protected com.github.funthomas424242.rezeptsammler.rezept.resource.rezept.IRezeptBracketPair getSelectedBracketPair() {
